...
const Sidebar = (props: Props) => {
  ...
  return (
    <>
      <Flex className="navigationBar"  width='250px' height='982px' direction='column' justify='between'  id="sidebar" p='16px 24px 32px' gap='84px' position='fixed' left='0' top='0'>


          <Flex className="top" direction='column'  gap='32px' m='o auto' width='202px' height='568px' flexGrow='0' >
          ...
          <Flex className="bottom" direction='column'  gap='32px' m='0 auto' width='202px' height='68px' flexGrow='0'>
